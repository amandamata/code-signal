using code_signal;
using static code_signal.LibrarySystem;
...
// librarySystem.AddBook("A man called Ove", "Some author", "2014");
// librarySystem.ListBooksAvaiable();
// librarySystem.AddUser("12345", "Amanda Mata");
// librarySystem.Borrow("A man called Ove", "12345");
// librarySystem.ListBooksAvaiable();
// librarySystem.ReturnBook("A man called Ove", "12345");
// librarySystem.ListBooksAvaiable();
...
// taskSystem.AddTask("First task");
// taskSystem.ListAllTasks();
// taskSystem.AddTask("Second task");
// taskSystem.ListAllTasks();
// taskSystem.UpdateTaskStatus("Second task", TaskSystem.Status.InProgress);
// taskSystem.ListAllTasks();
// taskSystem.ListTaskByStatus(TaskSystem.Status.Pending);
